...
#		Bolt v1.6.13 preinstalled
#
#	HISTORY:
#		2014/11/06 -	Created	- jupe
#
#================================================================
...
post_update()
{
	...
	$CMD_CHMOD 777 -R "${QPKG_DIR}/files" "${QPKG_DIR}/app/database" "${QPKG_DIR}/app/cache" "${QPKG_DIR}/app/config" "${QPKG_DIR}/theme"
}
